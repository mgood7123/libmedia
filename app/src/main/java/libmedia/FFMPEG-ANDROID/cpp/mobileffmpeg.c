        ...
        if (callbackData != NULL) {
            if (callbackData->type == 1) {
                ...
                (*env)->SetByteArrayRegion(env, byteArray, 0, size,
                                           (jbyte *) callbackData->logData);
                (*env)->CallStaticVoidMethod(env, configClass, logMethod, callbackData->logLevel,
                                             byteArray);
...
Java_com_arthenica_mobileffmpeg_Config_setNativeLogLevel(JNIEnv *env, jclass object, jint level) {
...
Java_com_arthenica_mobileffmpeg_Config_getNativeLogLevel(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_arthenica_mobileffmpeg_Config_enableNativeRedirection(JNIEnv *env, jclass object) {
    mutexLock();
 ...
 */
JNIEXPORT void JNICALL
Java_com_arthenica_mobileffmpeg_Config_disableNativeRedirection(JNIEnv *env, jclass object) {
...
Java_com_arthenica_mobileffmpeg_Config_getNativeFFmpegVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_arthenica_mobileffmpeg_Config_getNativeVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_arthenica_mobileffmpeg_Config_nativeFFmpegExecute(JNIEnv *env, jclass object,
 ...
 */
JNIEXPORT void JNICALL
Java_com_arthenica_mobileffmpeg_Config_nativeFFmpegCancel(JNIEnv *env, jclass object) {
    cancel_operation();
}
...
Java_com_arthenica_mobileffmpeg_Config_registerNewNativeFFmpegPipe(JNIEnv *env, jclass object,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_arthenica_mobileffmpeg_Config_getNativeBuildDate(JNIEnv *env, jclass object) {
    char buildDate[10];
 ...
 */
JNIEXPORT int JNICALL
Java_com_arthenica_mobileffmpeg_Config_setNativeEnvironmentVariable(JNIEnv *env, jclass object,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_arthenica_mobileffmpeg_Config_getNativeLastCommandOutput(JNIEnv *env, jclass object) {
    if (lastCommandOutput != NULL) {
